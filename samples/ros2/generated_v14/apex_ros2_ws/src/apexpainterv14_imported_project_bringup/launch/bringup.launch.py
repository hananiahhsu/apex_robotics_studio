...
def generate_launch_description():
    config = os.path.join(get_package_share_directory('apexpainterv14_imported_project_bringup'), 'config', 'project.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            package='apexpainterv14_imported_project_bringup',
